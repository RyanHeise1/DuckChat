...
#define REQ_SS_WHO      11
#define REQ_SS_LIST     12
...
struct request_ss_who{
        request_t req_type; /* = REQ_SS_WHO */
        char req_channel[CHANNEL_MAX]; 
} packed;

struct request_ss_list{
        request_t req_type; /* = REQ_SS_LIST */
} packed;
